    ...
    <div class="container-fluid container-banner">
        ...
        <div class="single-channel-nav">
            <nav class="navbar navbar-expand-lg navbar-light">
                <h1 class="channel-brand" href="<?= site_url($category->slugs); ?>"><?= $category->name; ?>
                    ...
                    <div class="tab-pane fade in active" id="tab1danger">
                        <div class="video-block section-padding">
                            <div class="row">
                                ...
                                <?= modules::run('site-videos-blocks/site_boxed/post_boxed_main_block_category', array(
                                    'boxed_header' => array(
                                        'title'         => $category->name,
                                        'category_slug' => $category->slugs,
                                        'url'           => site_url($category->slugs),
                                        'color'         => 'color_1',
                                        'icon'          => 'fa fa-coffee',
                                        'template'      => 'post_boxed_section_list_video',
