...
use nguyenanhung\ThuDoMultimediaSDKServices\VinaPhone\Http\VasCloudSmsSender;

/**
 * Class WebServiceVasCloudSMS
 *
 * @property mixed input
 * @property mixed output
 * @property mixed config
 */
class WebServiceVasCloudSMS extends CI_Controller
{
    /** @var mixed SDK Config */
    private $sdkConfig;

    /**
     * WebServiceVasCloudSMS constructor.
     */
    ...
    public function sendSms()
    {
        ...
        $request     = new VasCloudSmsSender($this->sdkConfig['OPTIONS']);
