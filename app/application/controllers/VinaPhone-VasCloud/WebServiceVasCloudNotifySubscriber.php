...
use nguyenanhung\ThuDoMultimediaSDKServices\VinaPhone\Http\VasCloudNotifySubscriberData;

/**
 * Class WebServiceVasCloudNotifySubscriber
 *
 * @property mixed input
 * @property mixed output
 * @property mixed config
 */
class WebServiceVasCloudNotifySubscriber extends CI_Controller
{
    /** @var mixed SDK Config */
    private $sdkConfig;
    private $config_vtvcabon;

    /**
     * WebServiceVasCloudNotifySubscriber constructor.
     */
    ...
    /**
     * WebService nhận và xử lý Request Notify Subscriber từ VasCloud Event Notifier
     *
     * Mục đích: đồng bộ sự kiện đăng ký, hủy của khách hàng thông qua vascloud.
     * Phương thức: HTTP POST
     * URL: CP cung cấp URL để Module Event Notifier đẩy sự kiện DK/HUY
     *
     * Được xây dựng trên chuẩn API VasCloud mới của VinaPhone
     *
     * Chi tiết tham khảo file: https://bit.ly/vina-vas-cloud
     *
     * @link  /vascloud/v1/notifySubscriber
     *
    ...
    public function index()
    {
        ...
        $request     = new VasCloudNotifySubscriberData($this->sdkConfig['OPTIONS']);
