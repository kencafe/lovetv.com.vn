...
use nguyenanhung\ThuDoMultimediaSDKServices\VinaPhone\Commands\VasCloudCommandSyncCDR;

/**
 * Class CommandsVasCloudProcessCDR
 *
 * @property mixed input
 * @property mixed output
 * @property mixed config
 */
class CommandsVasCloudProcessCDR extends CI_Controller
{
    /** @var mixed SDK Config */
    private $sdkConfig;

    /**
     * CommandsVasCloudProcessCDR constructor.
     */
     ...
     *
     * @link    /VasCloud/Commands/CDR/new
     * @link    /VasCloud/Commands/CDR/old
     *
     * @command 10 0 1 * * php index.php VasCloud Commands CDR old
     * @command *\/30 * * * * php index.php VasCloud Commands CDR old
     *
    ...
    public function run($timeFormat = NULL)
    {
        if (is_cli()) {
            try {
                $process = new VasCloudCommandSyncCDR($this->sdkConfig['OPTIONS']);
