...
class Db_queues_error_model extends TD_VAS_Based_model
{
    /**
     * Db_queues_error_model constructor.
     */
    public function __construct()
    {
        parent::__construct();
        $this->db               = $this->load->database('db_vinaphone_services', TRUE, TRUE);
        $this->tableName        = 'queues_error';
        $this->primary_key      = 'id';
        $this->field_service_id = 'service_id';
        $this->field_route      = 'route';
...
/* End of file Db_queues_error_model.php */
/* Location: ./based_core_apps_thudo/models/Vina_Services/Db_queues_error_model.php */
