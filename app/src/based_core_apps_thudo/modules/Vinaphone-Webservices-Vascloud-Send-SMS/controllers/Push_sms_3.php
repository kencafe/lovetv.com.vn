    ...
    public function index()
    {
        ...
        elseif ($input_signature != $valid_signature)
        {
            $response = array(
                ...
                'valid' => (ENVIRONMENT === 'production') ? $valid_signature : $valid_signature
            );
        }
        else
        {
            ...
            $data_xml = trim('<?xml version="1.0" encoding="utf-8"?><ACCESSGW xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">'.$content_xml.'</ACCESSGW>');
            if ($this->DEBUG === true)
            {
